pipeline {
    agent any
    environment {
        TF_VAR_gcp_project = "qwiklabs-gcp-00-e4a6c838e9a3"
        TF_VAR_bucket = "tf-remote-state-student_02_9e4ded9fd530-8205-4381"
        REPOSITORY = "https://github.com/mcsmik/sample-awx-project"
